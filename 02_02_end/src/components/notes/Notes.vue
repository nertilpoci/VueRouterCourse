<template>
  <div class="row g-0" v-if="!editingNote">
    <div class="col-12">
      ...
      <router-link to="/notes/new" class="float-end btn btn-link"><i class="fa fa-plus"></i></router-link>
    ...
    <div class="col-8">
      ...
      >
       <div
        ...
        >
              <router-link custom :to="'/notes/edit/'+ todo.id" v-slot="{navigate}" >
              <NoteItemCard @delete="deleteNote(todo.id)" @click="navigate"  class="m-1" :value="todo"> </NoteItemCard>
      ...
      <div v-else class="list-group m-1 p-3">
         <router-link custom :to="'/notes/edit/'+ todo.id" v-slot="{navigate}" >
        <NoteItemList @click="navigate"  @delete="deleteNote(todo.id)" 
          class="m-2"
          :key="todo.id"
          :value="todo"
